...
source_folder = r"C:\Users\Михаил\Desktop\Фото Kevon\В работе\1\Право"
...
for filename in os.listdir(source_folder):
    if filename.lower().endswith(('.png', '.jpg', '.jpeg')):  # Проверяем, является ли файл изображением
        ...
        # Вычисляем позицию для наложения (нижний правый угол)
...
#напиши код на Python: из папки C:\Users\Михаил\Desktop\Фото Kevon\Смесители для раковины\Право  - берем фотографии и на них накладываем в нижний правый угол изображение: "C:\Users\Михаил\Desktop\Фото Kevon\Смесители для раковины\Kevon by Haiba.png". Сохраняем фото с исходным именем.